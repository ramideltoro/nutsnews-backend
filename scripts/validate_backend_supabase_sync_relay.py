...
def main() -> int:
    ...
    for token in (
        ...
        "Inspect backend Supabase sync relay timer failure state",
        "Inspect backend Supabase sync relay service failure state",
