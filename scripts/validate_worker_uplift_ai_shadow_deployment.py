...
SERVICES = [
    {
        ...
        "digest": "sha256:0d45c0a8d023cfa499e1197e5804734b3cf501552740d3ae7c638f4f1212bfb9",
        "tag": "70c51a65123a4990c6a756d41bbb7566eb3f326b",
        "port": "18085",
        "queue": "nutsnews.worker.approval.v1",
        "publishes": "nutsnews.worker.translation.v1",
        "schema": "worker_uplift_approval",
        "secrets": ("approval-database-url", "approval-rabbitmq-url", "approval-qwen-base-url", "approval-qwen-api-key", "reconciliation-token"),
    ...
    },
    {
        ...
        "digest": "sha256:eed2ca084b30d1db6b1fc9b51ac4e4444ec8841b548a825c97b48f9467b0ead9",
        "tag": "22e918518945b3db633c81c09f816b9983f49dfd",
        "port": "18086",
        "queue": "nutsnews.worker.translation.v1",
        "publishes": "nutsnews.worker.persistence.v1",
        "schema": "worker_uplift_translation",
        "secrets": ("translation-database-url", "translation-rabbitmq-url", "translation-qwen-base-url", "translation-qwen-api-key", "reconciliation-token"),
        ...
        "services": [
            {
                ...
                "build_revision": service["tag"],
                "image_digest": service["digest"],
                "runtime_mode": "shadow",
                "network_mode": "host",
                "replicas": 1,
                "resources": {"memory": "512m", "cpus": "0.75"},
                "healthcheck": {"test": ["CMD", "node", "-e", f"fetch('http://127.0.0.1:{service['port']}/live')"]},
                "provenance": {
                    "required": True,
                    "signed": True,
    ...
    for service in SERVICES:
        require(
            ...
            (
                ...
                "runtime_mode: shadow",
                "network_mode: host",
                f"127.0.0.1:{service['port']}/live",
                "service_version: \"0.1.0\"",
                f"build_revision: {service['tag']}",
                f"image_digest: {service['digest']}",
                f"{service['prefix']}_DEPENDENCY_MODE: production",
                f"{service['prefix']}_SHADOW_MODE: \"true\"",
